...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loader.init(ImageLoaderConfiguration.createDefault(Main2Activity.this));//loader初始化

        loader.displayImage("https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=167154" + "952,3594779114&fm=200&gp=0.jpg",iv_photo1);//展示图片
