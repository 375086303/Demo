package com.example.myfuck.demo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Vitamio.isInitialized(this)){
            ...
            vv.setVideoURI(Uri.parse("http://misc.dyhoa.com/exam/video/1/course2/27.MP4"));
            ...
            mCustomMediaController = new CustomMediaController(MainActivity.this, vv, this);
            ...
            //获取上一次保存的进度
            int progress = (int) spUtils.getShared(this, "progress");//此处使用SharedPreferences保存当前播放进度，SPUtils是我自己封装的工具类
